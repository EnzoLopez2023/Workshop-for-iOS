    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 0) {
            ...
            VStack(alignment: .leading, spacing: 8) {
                SkeletonBlock(height: 10, width: 70, cornerRadius: 99)
                SkeletonBlock(height: 18, width: 130)
                SkeletonBlock(height: 13, width: 170)
                SkeletonBlock(height: 13, width: 110)
                HStack(spacing: 8) {
                    SkeletonBlock(height: 22, width: 60, cornerRadius: 99)
                    SkeletonBlock(height: 22, width: 76, cornerRadius: 99)
                }
                .padding(.top, 4)
            }
            .padding(14)
        }
        .background(Theme.paper).clipShape(RoundedRectangle(cornerRadius: 14))
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 0) {
            ...
            VStack(alignment: .leading, spacing: 14) {
                SkeletonBlock(height: 22, width: 90, cornerRadius: 99)

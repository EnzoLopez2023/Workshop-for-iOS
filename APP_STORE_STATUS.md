...
| Current App Store screenshots | None in source; recapture from the exact release candidate |
...
- The integrated scheme passed 9 tests: 7 unit and 2 UI tests.
- UI tests captured the Settings surface and the exact shared confirmation view
...
- Capture current store screenshots from the exact release candidate and
  validate the final set against App Store dimensions and product truth.
- Create and inspect a fresh signed archive/export, then complete TestFlight,
  App Privacy, support URL, pricing/storefront, metadata, and review evidence.
